...
//                    currentTime.totalNsecs()));
    ...
    private synchronized void publishCameraInfo(int type, std_msgs.Header header) {
        TFMessage tfMessage1 = mTfPubr.newMessage();
        mTfPubr.publish(tfMessage1);
        Log.d(TAG, "hopefully published tf...");
...
//        else {
//            Log.d(TAG, "publishCameraInfo type not implemented. returning.");
//            return;
//        }
        else {
